...
public interface IOrderDao {
    ...
    List<PayOrder> queryStaleMarketSettlementOrderList();

    List<PayOrder> queryStaleWaitRefundOrderList();

    List<PayOrder> queryStalePayWaitOrderList();

    int countStalePayWaitOrder();

    int countStaleMarketSettlementOrder();

    int countStaleWaitRefundOrder();
