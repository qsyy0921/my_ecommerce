...
public class TimeoutRefundJob {
    ...
    public void exec() {
        ...
        try {
            ...
            execution = jobExecutionRecorder.start("market_timeout_refund", 60);
            ...
            if (timeoutOrderList == null || timeoutOrderList.isEmpty()) {
                ...
                jobExecutionRecorder.success(execution, 0, 0, "no timeout unpaid orders");
                return;
            }
            ...
            jobExecutionRecorder.success(execution, successCount, failCount, "scannedCount=" + timeoutOrderList.size());
