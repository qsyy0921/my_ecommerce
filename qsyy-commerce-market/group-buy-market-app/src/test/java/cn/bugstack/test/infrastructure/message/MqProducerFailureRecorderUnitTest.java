...
public class MqProducerFailureRecorderUnitTest {
    ...
    public void recordPublishFailureShouldInsertNewFailureRecord() {
        ...
        fixture.recorder.recordPublishFailure("market.exchange", "market.settlement", "{\"orderId\":\"001\"}", "msg_001", "timeout");

        Assert.assertNotNull(fixture.dao.insertedRecord);
        Assert.assertEquals("msg_001", fixture.dao.insertedRecord.getMessageId());
        Assert.assertEquals("market.exchange", fixture.dao.insertedRecord.getExchangeName());
        Assert.assertEquals("routing:market.settlement", fixture.dao.insertedRecord.getQueueName());
    ...
    public void recordPublishFailureShouldUpdateExistingFailureRecord() {
        ...
        fixture.recorder.recordPublishFailure("market.exchange", "market.settlement", "{\"orderId\":\"001\"}", "msg_001", "nack");
    ...
    public void recordPublishFailureShouldGenerateMessageIdWhenMissing() {
        ...
        fixture.recorder.recordPublishFailure("market.exchange", "market.settlement", "{\"orderId\":\"001\"}", null, longError);

        String expectedId = fixture.generator.build("market.exchange", "market.settlement", "{\"orderId\":\"001\"}");
