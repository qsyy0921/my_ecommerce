...
public class TeamSuccessTopicListener {
    ...
    @RabbitListener(
            bindings = @QueueBinding(
                    value = @Queue(value = "${spring.rabbitmq.config.consumer.topic_team_success.queue}", durable = "true",
                            arguments = {
    ...
    public void listener(String message, Message amqpMessage, Channel channel) throws Exception {
        ...
        try {
            ...
            log.info("receive team success callback messageId:{} requestDTO:{}", messageRecord.getMessageId(), JSON.toJSONString(requestDTO));
            ...
            log.error("consume team success callback failed messageId:{} body:{}", messageId, message, e);
