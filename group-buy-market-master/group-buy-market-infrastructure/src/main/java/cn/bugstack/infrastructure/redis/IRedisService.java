...
public interface IRedisService {
    ...
    /**
     * Atomically reserve seckill stock and mark the user as occupied.
     *
     * @return remaining stock when success, -1 when stock is empty, -2 when user already reserved.
     */
    Long reserveSeckillStock(String stockKey, String userKey, long userKeyTtl, TimeUnit timeUnit);

    /**
     * Atomically reserve sharded seckill stock, mark the user as occupied and store
     * a processing result for query.
     *
     * @return remaining stock in the selected bucket when success, -1 when stock is
     * empty, -2 when user already reserved.
     */
    Long reserveSeckillQualification(String stockKey, String userKey, String resultKey, String processingResult, long ttl, TimeUnit timeUnit);

    /**
     * Atomically reserve a group-buy team seat.
     *
     * @return occupy sequence when success, -1 when team is full, -2 when occupy lock is duplicated.
     */
    Long reserveTeamStock(String teamStockKey, String recoveryTeamStockKey, String occupyLockKeyPrefix,
