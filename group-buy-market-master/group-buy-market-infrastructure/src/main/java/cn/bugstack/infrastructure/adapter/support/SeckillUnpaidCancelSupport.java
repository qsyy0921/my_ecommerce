...
@Component
public class SeckillUnpaidCancelSupport {
    ...
    public void cancel(SeckillOrder seckillOrder, String refundReason) {
        int updated = seckillOrderTableGateway.closeUnpaid(seckillOrder.getUserId(), seckillOrder.getOutTradeNo(), seckillOrder.getOrderId());
        if (updated <= 0) {
