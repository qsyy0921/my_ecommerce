...
public class GroupBuyNotifyJob {
    ...
    public void exec() {
        ...
        try {
            ...
            execution = jobExecutionRecorder.start("market_group_buy_notify", 300);
            ...
            jobExecutionRecorder.success(execution, null == result.get("successCount") ? 0 : result.get("successCount"),
                    null == result.get("errorCount") ? 0 : result.get("errorCount"), JSON.toJSONString(result));
        } catch (Exception e) {
            if (null != execution) {
