...
public class RefundSuccessTopicListener {
    ...
    public void listener(String message, Message amqpMessage, Channel channel) throws Exception {
        ...
        try {
            ...
            log.info("receive refund success message messageId:{} body:{}", messageRecord.getMessageId(), message);
            ...
            log.error("consume refund success message failed messageId:{} body:{}", messageId, message, e);
