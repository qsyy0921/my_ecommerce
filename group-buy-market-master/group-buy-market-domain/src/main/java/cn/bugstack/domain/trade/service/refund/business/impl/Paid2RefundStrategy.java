...
public class Paid2RefundStrategy extends AbstractRefundOrderStrategy {
    ...
    public Paid2RefundStrategy(IGroupBuyRefundPort groupBuyRefundPort,
    ...
    public void refundOrder(TradeRefundOrderEntity tradeRefundOrderEntity) throws Exception {
        ...
        // 1. 退单，已支付&未成团
        NotifyTaskEntity notifyTaskEntity = groupBuyRefundPort.paid2Refund(GroupBuyRefundAggregate.buildPaid2RefundAggregate(tradeRefundOrderEntity, -1, -1));
