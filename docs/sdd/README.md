...
- `2026-05-31-seckill-outbox-ops-observability.md`：记录秒杀订单 Outbox 运维查询、状态计数、重试耗时指标和告警规则。
...
- `2026-05-31-seckill-rocketmq-adapter-profile-decision.md`：记录本机暂不实现 RocketMQ adapter 最小 profile 的决策、触发条件和后续实现边界。
